...
export const HORA_BATCH_COL = 6;  //HORA_BATCH DE PEDIDOS -> SE AGARRA LOS PEDIDOS EN LAS 6 HORAS DE REGISTRO.
export const HORA_ITER = 1000*60;  //TIMER -> SE LANZARÁ DE NUEVO LA SIMULACIÓN CADA 6 HORAS SIMULADAS -- AHORA ES 1 MINUTO. 
export const HORA_ITER_COL = 1000*60;  //TIMER -> SE LANZARÁ DE NUEVO LA SIMULACIÓN CADA 6 HORAS SIMULADAS -- AHORA ES 1 MINUTO. 
...
export const PROM_CARG = (90*6+45*15+30*24)/45;